...
(function($) {
    ...
    $(document).ready(function() {
        ...
        $('.main-menu li.dropdown > a').append("<i class='fa fa-caret-down'></i>");
        ...
        $('.testimonial-slider-home-2').slick({
            ...
            prevArrow: "<button type='button' class='slick-prev pull-left'><i class='fa fa-long-arrow-alt-left' aria-hidden='true'></i></button>",
            nextArrow: "<button type='button' class='slick-next pull-right'><i class='fa fa-long-arrow-alt-right' aria-hidden='true'></i></button>",
            responsive: [{
                    breakpoint: 1300,
                    settings: {
                        slidesToShow: 2
